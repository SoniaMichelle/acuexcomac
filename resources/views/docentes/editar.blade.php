            ...
            <div class="row no-gutters formBx">
                <div class="col px-5">
                    ...
                    <div class="p-5 bg-white rouded shadow-lg">
                        <form action="{{ route('docentes.update', $docentes) }}" method="POST" novalidate>
                            @csrf
                            @method('put')
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="nombre_docente" name="nombre_docente"
                                        placeholder="Nombre(s)" value="{{ old('nombre_docente',  $docentes->nombre_docente) }}">
                                    <div id="alerta"></div>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="ap_paterno_docente"
                                        ...
                                        value="{{ old('ap_paterno_docente',$docentes->ap_paterno_docente) }}">
                                    <div id="alerta1"></div>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="ap_materno_docente"
                                        ...
                                        value="{{ old('ap_materno_docente',$docentes->ap_materno_docente) }}">
                                    <div id="alerta2"></div>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="edad_docente" name="edad_docente"
                                        placeholder="Edad" value="{{ old('edad_docente',$docentes->edad_docente) }}">
                                    <div id="alerta3"></div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="curp_docente" name="curp_docente"
                                        placeholder="CURP" value="{{ old('curp_docente',$docentes->curp_docente) }}">
                                    <div id="alerta4"></div>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="rfc_docente">RFC</label>
                                    <input type="text" class="form-control" id="rfc_docente" name="rfc_docente"
                                        placeholder="RFC" value="{{ old('rfc_docente',$docentes->rfc_docente) }}">
                                    <div id="alerta5"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="email_docente" name="email_docente"
                                        placeholder="email" value="{{ old('email_docente',$docentes->email_docente) }}">
                                    <div id="alerta6"></div>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="tel_casa_docente" name="tel_casa_docente"
                                        placeholder="Telefono de casa(10 dígitos)" value="{{ old('tel_casa_docente',$docentes->tel_casa_docente) }}">
                                    <div id="alerta7"></div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="cel_docente">Telefono celular</label>
                                    <input type="text" class="form-control" id="cel_docente" name="cel_docente"
                                        placeholder="Telefono celular del docente(10 digitos)" value="{{ old('cel_docente',$docentes->cel_docente) }}">
                                    <div id="alerta8"></div>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-8">
                                    ...
                                    <input type=" text" class="form-control" id="calle_docente" name="calle_docente"
                                        placeholder="Calle y número" value="{{ old('calle_docente',$docentes->calle_docente) }}">
                                    <div id="alerta12"></div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="cp_docente">Código Postal</label>
                                    <input type="text" class="form-control" id="cp_docente" name="cp_docente"
                                        placeholder="Alcaldia" value="{{ old('cp_docente',$docentes->cp_docente) }}">
                                    <div id="alerta13"></div>
                                </div>
                            </div>
